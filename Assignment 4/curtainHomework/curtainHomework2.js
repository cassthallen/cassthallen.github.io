...
function setup()
{
    ...
    background(100);
    desiredColor1 = color(random(255), random(255), random(255))
    desiredColor2 = color(random(255), random(255), random(255))
    desiredColor3 = color(random(255), random(255), random(255))
    desiredColor4 = color(random(255), random(255), random(255))
